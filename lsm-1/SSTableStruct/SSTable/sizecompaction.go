...
//func NewSSTableCompact(newFilePath string, numberSSTable int, oldFilePath string, N, M, memtableLen int, compress1, compress2, oneFile bool) bool {
//
//	// pomocne promenljive
...
//	for true {
//
//		data, greska := getNextRecord(oldFilePath, startOffsetList, endOffsetList, compress1, oneFile)
//		fmt.Printf("Kljuc: %s\n", data.GetKey())
//		if greska == false {
//			return false
//		}
...
//		serializedData, err = SerializeDataType(data, compress1, compress2)
//		if err != nil {
//			return false
//		}
//
